...
{
    [Guid("8b51a94d-49bc-4910-9a1f-54090a53691d")]
    public class PluginServer : ApplicationAddInServer
    {
        ...
        {
            Trace.TraceInformation(": PluginPlugin (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");
        ...
        {
            Trace.TraceInformation(": PluginPlugin: deactivating... ");
